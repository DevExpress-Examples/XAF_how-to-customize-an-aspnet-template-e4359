<%@ Control Language="C#" CodeBehind="MyDefaultVerticalTemplateContent.ascx.cs" ClassName="MyDefaultVerticalTemplateContent" Inherits="CustomizeTemplate.Web.MyDefaultVerticalTemplateContent" %>
