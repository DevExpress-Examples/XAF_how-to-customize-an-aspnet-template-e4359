...
namespace CustomizeTemplate.Web {
    public partial class MyDefaultVerticalTemplateContent : TemplateContent, IXafPopupWindowControlContainer, IXafSecurityActionContainerHolder {
        static MyDefaultVerticalTemplateContent() {
