<%@ Control Language="vb" CodeBehind="MyDefaultVerticalTemplateContent.ascx.vb" ClassName="MyDefaultVerticalTemplateContent"
    CompilationMode="Auto" Inherits="CustomizeTemplate.Web.MyDefaultVerticalTemplateContent" AutoEventWireup="True" %>
