<%@ Control Language="vb" CodeBehind="MyDefaultVerticalTemplateContent.ascx.vb" ClassName="MyDefaultVerticalTemplateContent" Inherits="CustomizeTemplate.Web.MyDefaultVerticalTemplateContent" %>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <xaf:XafUpdatePanel ID="UPVH" runat="server" ForeColor="#2c86d3" Font-Size="X-Large" Style="white-space: normal;">
